...
| **System administration** | Configure service, roles, notifications, and operational policies where applicable. | Admin role in Flutter; environment-driven SMS/email (`AFRICAS_TALKING_*`, email); Render/hosting config; optional alert queue (`backend` alert modules). |
